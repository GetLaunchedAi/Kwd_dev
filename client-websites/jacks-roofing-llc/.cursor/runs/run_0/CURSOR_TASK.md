...
**Objective**: Change the hero text to say "Yunus the great is amazing"
...
## 2. Metadata
**ClickUp Task**: https://app.clickup.com/t/86b8255ba
**Task ID**: 86b8255ba
**Client**: Unknown
...
4. **Commit**: Commit your changes with a message like `task: [86b8255ba] description`.
